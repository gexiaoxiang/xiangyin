    ...
    <div class="trade-container">
        ...
        <div class="trade">
            ...
            <div class="receiveInfo">
                寄送至:
                <span>{{ userDefaultAddress && userDefaultAddress.fullAddress }}</span>
                收货人：<span>{{ userDefaultAddress && userDefaultAddress.consignee }}</span>
                <span>{{ userDefaultAddress && userDefaultAddress.consignee }}</span>
            </div>
        </div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            this.$store.dispatch('getUseAddress')
